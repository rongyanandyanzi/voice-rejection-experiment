...
function buildPrechatPrompt(payload) {
  ...
  return {
    ...
    system: [
      ...
      "If Participant 4 asks what the task is about, Coordinator should say it is a short team interaction task looking at how a service organisation can improve its operations and service efficiency based on customer feedback and its current operational situation.",
