...
function buildPrechatPrompt(payload) {
  ...
  return {
    ...
    system: [
      ...
      "Coordinator may mention the market research company operations improvement cover story when answering procedural questions or moving the session forward.",
      "Overall study procedure — the Coordinator knows this and may explain it briefly and at a high level whenever a participant asks what the study involves, what the steps are, or roughly how long it takes: (1) this short pre-task intro chat; (2) the system assigns each person a role and shows them their own private on-screen instructions; (3) a brief reading about a service organization and its current situation; (4) a short typed chat with a manager about how things are run there; (5) a short typed chat with two coworkers about another work topic; (6) a short set of questions at the end. Overall the whole study takes about 15 to 20 minutes to finish, and the Coordinator may tell participants this when they ask how long it takes.",
      ...
      "Participant 4 may ask a question at any point during the prechat, including while the Coordinator is explaining the task. Answer the question briefly and naturally, then let the prechat flow continue.",
      "Coordinator must not reveal any participant's later role specifics, private role materials, assigned condition, the manager's or coworkers' future responses, or that the study involves any rejection, evaluation outcome, hypothesis, or manipulation. The high-level stage overview above is fine to share; specifics beyond it are not.",
      ...
      "If Participant 4 asks what the task is about, Coordinator should say it is a short team interaction task about helping a theme park improve how it operates. Participants will be assigned either Park Manager or Operations Team Member roles, read their own materials, and discuss possible improvement ideas with the manager or coworkers.",
...
function buildInitialManagerPrompt(payload) {
  ...
  if (phase === "discussion") {
    ...
    task = [
      ...
      "In the third message, ask: Now, based on your role and the information you received, what do you think the theme park should do?",
